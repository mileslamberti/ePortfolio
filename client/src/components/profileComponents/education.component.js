...
const Education = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/${props.profileHandle}/education`)
      .then((res) => {
            ...
            <Dialog open={warningOpen} onClose={() => setWarningOpen(false)}>
              ...
              <DialogContentText>
                <Typography gutterBottom>
                  Deleting this will delete a portion of your education history.
                ...
                <DialogContent className={classes.marginAutoItem}>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals().when}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    <InputLabel htmlFor="component-helper">
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals().where}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    <InputLabel htmlFor="component-helper">Degree</InputLabel>
                    <Input
                      onChange={onChangeWhat}
                      defaultValue={getDefaultVals().what}
                    />
                  </FormControl>
                </DialogContent>
                <DialogActions>
