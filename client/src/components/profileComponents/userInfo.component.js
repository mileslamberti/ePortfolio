...
const UserInfo = (props) => {
  ...
  const getDefaultVals = (vals) => {
    ...
    if (defaultVals.occupation === "Occupation") {
      defaultVals.occupation = "";
    }
    if (defaultVals.location === "Location") {
      defaultVals.location = "";
    }
    if (defaultVals.number === "Phone number") {
      defaultVals.number = "";
    }
    if (defaultVals.email === "Contact email") {
      defaultVals.email = "";
    }
  ...
  const onSubmit = (e) => {
    ...
    axios
      .post("/userinfo", updatedUserInfo, { headers: authHeader() })
      .then((res) => {
                ...
                <DialogContent className={classes.marginAutoItem}>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals(userInfo).occupation}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals(userInfo).location}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    <InputLabel htmlFor="component-helper">
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals(userInfo).number}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    <InputLabel htmlFor="component-helper">
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals(userInfo).email}
                    />
                  </FormControl>
                </DialogContent>
                <DialogActions>
