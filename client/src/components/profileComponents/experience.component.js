...
const Experience = (props) => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`/${props.profileHandle}/experience`)
      .then((res) => {
  ...
  const getDefaultVals = () => {
    ...
    if (selectedExperience === "") {
      ...
      defaultVals.jobDescription =
        experiences[selectedExperience].jobDescription;
    }
    return defaultVals;
  };
            ...
            <Dialog open={warningOpen} onClose={() => setWarningOpen(false)}>
              ...
              <DialogContentText>
                <Typography gutterBottom>
                  Deleting this will delete a portion of your work history. Are
        ...
        <>
          ...
          {authorised ? (
            <>
              <IconButton>
                {" "}
                <Add onClick={handleAddExperience} />{" "}
              </IconButton>
              <Dialog
                open={open}
                onClose={handleClose}
                ...
                <DialogContent className={classes.marginAutoItem}>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals().date}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals().companyName}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    <InputLabel htmlFor="component-helper">
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals().jobTitle}
                    />
                  </FormControl>
                  <FormControl className={classes.alignItemsAndJustifyContent}>
                    <InputLabel htmlFor="component-helper">
                    ...
                    <Input
                      ...
                      defaultValue={getDefaultVals().jobDescription}
                    />
                  </FormControl>
                </DialogContent>
                <DialogActions>
